...
export type BillingLineKind = 'base' | 'seat' | 'branch' | 'site' | 'module_addon' | 'extra_addon' | 'usage' | 'discount' | 'adjustment'
export const BILLING_LINE_KINDS: BillingLineKind[] = ['base', 'seat', 'branch', 'site', 'module_addon', 'extra_addon', 'usage', 'discount', 'adjustment']
