...
const STATUS_LABELS: Record<string, { status: BadgeProps['status']; label: string }> = {
  ...
  'En tránsito': { status: 'info',    label: 'En tránsito' },
  // Expensas / compras / recepciones
  Confirmado:   { status: 'info',    label: 'Confirmado' },
  Confirmada:   { status: 'info',    label: 'Confirmada' },
  Recibido:     { status: 'info',    label: 'Recibido' },
  Recibida:     { status: 'info',    label: 'Recibida' },
  'Recibido parcial': { status: 'pending', label: 'Recibido parcial' },
  Enviado:      { status: 'info',    label: 'Enviado' },
  Enviada:      { status: 'info',    label: 'Enviada' },
  Devuelto:     { status: 'error',   label: 'Devuelto' },
  'Devuelto parcial': { status: 'pending', label: 'Devuelto parcial' },
  Pagado:       { status: 'success', label: 'Pagado' },
