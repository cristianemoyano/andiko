  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        ...
        if (order.payment_condition) setPaymentCondition(order.payment_condition as PaymentCondition)
    ...
    <div className="flex flex-col h-full">
      ...
      <PageBody>
        <div className="max-w-4xl mx-auto flex flex-col gap-5">
          <div className="pt-1">
            <h1 className="text-xl font-semibold tracking-tight text-fg">Nueva factura de proveedor</h1>
            <p className="mt-0.5 text-[13px] text-fg-muted">
              Registrá el comprobante recibido y vinculalo con la compra correspondiente.
            </p>
          </div>
