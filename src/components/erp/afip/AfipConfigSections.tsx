...
function CertificadoSection({ defaultCuitDigits }: { defaultCuitDigits?: string }) {
  ...
  const [prevDefaultCuit, setPrevDefaultCuit] = useState(defaultCuitDigits)
  if (
    defaultCuitDigits &&
    defaultCuitDigits.length === 11 &&
    defaultCuitDigits !== prevDefaultCuit
  ) {
    setPrevDefaultCuit(defaultCuitDigits)
    setCuit((prev) => prev || defaultCuitDigits)
  }
...
export {
  DatosFiscalesSection as AfipDatosFiscalesSection,
  PieTicketPosSection as AfipPieTicketPosSection,
  PuntosDeVentaSection as AfipPuntosDeVentaSection,
  CertificadoSection as AfipCertificadoSection,
  ContingencySection as AfipContingencySection,
}
