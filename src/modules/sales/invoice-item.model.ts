...
export interface InvoiceItemAttributes extends Timestamps, AuditFields {
  id: UUID
  invoice_id: UUID
...
class InvoiceItem extends AuditModel<InvoiceItemAttributes, InvoiceItemCreationAttributes> {
  declare id: UUID
...
InvoiceItem.init(
  ...
  { sequelize, tableName: 'invoice_items', paranoid: true, underscored: true }
)
