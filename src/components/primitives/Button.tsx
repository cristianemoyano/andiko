...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-1.5 font-medium rounded-sm transition-[color,transform] duration-150 ease-out active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-1 disabled:pointer-events-none disabled:scale-100 disabled:bg-surface-hover disabled:text-fg-subtle disabled:border-border cursor-pointer',
  {
    variants: {
      variant: {
