...
const LINKS = [
  { href: '/expensas/facturas',    label: 'Facturas' },
  { href: '/expensas/recurrentes', label: 'Recurrentes' },
  { href: '/expensas/pagos',       label: 'Pagos' },
] as const

export function ExpensasSubNav() {
  ...
  return (
    <nav
      ...
      aria-label="Secciones de expensas"
    >
