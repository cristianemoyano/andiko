...
export type StockReferenceType = 'order' | 'invoice_cancel' | 'manual' | 'initial' | 'purchase_receipt' | 'delivery_note' | 'sales_return' | 'sales_exchange' | 'purchase_return' | 'purchase_exchange'
